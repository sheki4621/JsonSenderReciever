...
class JsonSenderMessageHandlerTest {
    ...
    void handleMessage_shouldLogThresholdUpdateAndCallService(CapturedOutput output) {
        ...
        assertThat(output.getOut()).contains(
                "しきい値変更通知を受信: instance=test-instance, config=Threshold(hostname=test-host, scalingMode=null, upperChangeableEnable=null, upperCpuThreshold=90.0, upperCpuDurationMin=0, upperMemThreshold=null, upperMemDurationMin=0, upperConditionLogic=null, lowerChangeableEnable=null, lowerCpuThreshold=null, lowerCpuDurationMin=0, lowerMemThreshold=null, lowerMemDurationMin=0, lowerConditionLogic=null, microChangeableEnable=null, microForceOnStandby=null)");
